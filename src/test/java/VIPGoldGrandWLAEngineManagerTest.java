...
public class VIPGoldGrandWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(VIPGoldGrandWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/VIPGoldGrandWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/VIPGoldGrandWLAIW/InitOutcome.xml").getDocumentElement();
